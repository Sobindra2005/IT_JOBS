      ...
      <div className="w-1/4 p-5 h-3/4   ">
        <div className=" p-7  shadow-md  cursor-pointer flex flex-col shadow-gray-300 border-l-2 border-t-2 bg-white  border-sky-200 rounded-xl h-full ">
          <div className="text-base py-3 pt-6 border-t-2 border-gray-200 ">
            <i className="bi bi-person-fill hover:bg-gray-400  border mr-1 bg-gray-300  text-2xl text-black rounded-lg p-1 "></i>  Profile
          </div>
          <div className="text-base  py-2  ">
            <i className="bi bi-pencil-square  mr-1 hover:bg-gray-400 bg-gray-300  text-2xl text-black rounded-lg p-1 "></i>  Edit profile
          </div>
