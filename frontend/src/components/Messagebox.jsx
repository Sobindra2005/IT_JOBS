  ...
  return (
    <>
      <div className=" Message z-10 bg-white fixed right-80 bottom-6 mt-16 border rounded-3xl  cursor-pointer h-2/3  w-1/4  shadow-lg shadow-blue-500/50 ">
        ...
        {/* bottom component */}
        <div className=" absolute  bottom-0 w-full pt-3 mb-0 flex pb-2 flex-row justify-center  h-auto  rounded-3xl">
         
            <textarea className=" rounded-md p-2 resize-none outline-none  h-auto  w-10/12 text-base px-2 text-slate-800 bg-slate-200 " type="text" placeholder="write messages.."></textarea>
